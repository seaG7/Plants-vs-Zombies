    ...
    public class ETFXProjectileScript : MonoBehaviour
    {
        ...
        {	
            ...
            if (transform.GetComponent<Rigidbody>().useGravity)
                direction += UnityEngine.Physics.gravity * Time.deltaTime; // Accounts for gravity if enabled
            ...
            if (UnityEngine.Physics.SphereCast(transform.position, radius, direction, out hit, detectionDistance)) // Checks if collision will happen
            {
